...
apiRoutes.get('/getAlumnos', auth.isAuth, async (req, res) => await alumnoController.findAll(req, res))
    ...
    .put('/update', auth.isAuth, async (req, res) => await alumnoController.update(req, res))
    .put('/updateStatus', auth.isAuth, async (req, res) => await alumnoController.updateStatus(req, res));
